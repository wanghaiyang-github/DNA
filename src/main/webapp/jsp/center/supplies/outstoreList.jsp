        ...
        <div id="wrapper-content">
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form id="queryForm" action="<%=path%>/center/storage/outStorageList.html" class="form-horizontal tasi-form" method="post">
                                <div class="form-group">
                                    ...
                                    <label class="col-sm-2 control-label" style="text-align:center;">出库名称</label>
                                    <div class="col-sm-3">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" style="text-align:center;">出库时间</label>
                                    <div class="col-sm-3">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" style="text-align:center;">出库人</label>
                                    <div class="col-sm-3">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            <span class="label label-primary">出库列表</span>
                            <span class="tools pull-right">
                                <a href="javascript:;" class="fa fa-chevron-down"></a>
                            </span>
                        </header>
...
<script>
    $(function(){
        ...
        $("#addBtn").on("click", function(){
            location.href = "<%=path%>/center/storage/outStorage.html?operateType=1";
        });

        $("button[name='modifyBtn']", "#storageRecordInfoListTbody").on("click", function(){
            var id = $("#storageRecordInfoId", $(this).parent()).val();

            location.href = "<%=path%>/center/storage/outStorage.html?id=" + id + "&operateType=2";
        });
        ...
        kkpager.generPageHtml({
            ...
            //链接前部
            hrefFormer : '<%=path%>/center/storage/outStorageList',
            //链接尾部
            hrefLatter : '.html',
