                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <select class="form-control" id="panelIdSelect">
                                        <c:forEach items="${panelInfoList}" var="panelInfo" varStatus="do">
                                            <option value="${panelInfo.id}" <c:if test="${limsSampleGene.panelId eq panelInfo.id}">selected</c:if>>${panelInfo.panelName}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-6 col-lg-10">
                                    ...
                                    <button class="btn btn-lg btn-info" id="backBtn" type="button"  onclick="javascript:history.go(-1);"><i class="fa fa-reply"></i> 返 回 </button>
                                </div>
                            </div>
    ...
    $(function() {
        ...
        function viewGeneDetail(geneInfo) {
            if(typeof(geneInfo)!="undefined" && geneInfo!=0){
                $("#panelIdSelect").append("<option value='' <c:if test='${limsSampleGene.panelId eq 0}'>selected</c:if>></option>");
                ...
                for(var i = 0; i < len; i++){
                    ...
                    htmlStr += "<td><input type='text' name='gene1' id='gene1' value="+ gene.geneVal1 +"></td>";
                    htmlStr += "<td><input type='text' name='gene2' id='gene2' value="+ gene.geneVal2 +"></td>";
                    htmlStr +="</tr>";
                }
        ...
        $("#panelIdSelect").on("change", function () {
            panelSelectChange();
        });
        ...
        function getParams(){
            ...
            geneInfo.panelId = $("#panelIdSelect").val();
                ...
                success:function(data){
                    ...
                    if(typeof(data[0].geneInfo)!="undefined" && data[0].geneInfo!=null){
                        ...
                        for(var i =0; i < dataLen;i++){
                            ...
                            htmlStr += "<td><input type='text' name='gene1' id='gene1' value="+ data[i].geneVal1 +"></td>";
                            htmlStr += "<td><input type='text' name='gene2' id='gene2' value="+ data[i].geneVal2 +"></td>";
                            htmlStr +="</tr>";
                        }
                    }
