                        ...
                        <div class="panel-body">
                            <form id="consignment_form" class="form-horizontal tasi-form" method="get">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control required" id="identifyRequirement" value="${consignment.identifyRequirement}" readonly/>
                                    </div>
                                    <div class="col-sm-2 has-error hide">
                                        <p class="help-block">必填项</p>
                                    </div>
                                    ...
                                    <c:if test="${fn:length(supplySampleInfoList) gt 0}">
                                        <c:forEach items="${supplySampleInfoList}" var="supplySample" varStatus="p">
                                            <c:if test="${supplySample.sampleFlag eq 1}">
                                                <tr>
                                                    <td><input type='hidden' name='sampleName' value='${supplySample.sampleName}'/>${supplySample.sampleName}</td>
...
<script src="<%=path%>/js/identifyRegSupply.js"></script>
<script>
