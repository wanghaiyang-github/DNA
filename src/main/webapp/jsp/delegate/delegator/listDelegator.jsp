    ...
    <aside>
        <div id="sidebar" class="nav-collapse">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                    <a href="<%=path%>/wt/consignment/listDelegator.html" class="active">
                        委托人管理
                    </a>
                </li>
            </ul>
                        ...
                        <div class="panel-body">
                            <div class="clearfix">
                                <div class="btn-group">
                                    ...
                                    <input type="hidden" id="delegateOrgId" name="delegateOrgId" value="${delegateOrg.id}">
                                    <input type="hidden" id="delegateOrgDefaultName" name="delegateOrgDefaultName" value="${delegateOrg.orgName}">
                                </div>
                            </div>
...
<script>
    $(function(){
        ...
        $("#saveBtn").on("click",function(){
            ...
            $.ajax({
                url:"<%=path%>/wt/consignment/addOrEditLimsConsignmentInfo.html?operate=" + operate,
                type:"post",
                ...
                success: function (data) {
                    if(data.success){
                        location.href='<%=path%>/wt/consignment/listDelegator.html';
                    }else {
                        alert("操作失败!");
                    }
                },
        ...
        $("button[name='delBtn']","#consignmentInfoListTbody").on("click",function(){
            if(confirm("确认要删除吗？")){
                ...
                $.ajax({
                    url:"<%=path%>/wt/consignment/delLimsConsignmentInfo.html?id=" + id,
                    type:"get",
                    dataType:"json",
                    success: function (data) {
                        if(data.success){
