                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form id="storageInfoForm" action="<%=path%>/center/storage/listStorageInfo.html" class="form-horizontal tasi-form" method="get">
                            ...
                            <table class="table table-striped table-advance table-bordered table-hover">
                                ...
                                <c:forEach items="${reagentSuppliesInfoList}" var="reagentSuppliesInfo" varStatus="g">
                                    <tr>
                                        ...
                                        <td>${reagentSuppliesInfo.storageNum}</td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
...
<script>
    $(function(){
        ...
        kkpager.generPageHtml({
            ...
            //链接前部
            hrefFormer : '<%=path%>/center/storage/listStorageInfo',
            //链接尾部
            hrefLatter : '.html',
            getLink : function(page){
                return this.hrefFormer + this.hrefLatter + "?" + "page=" + page + "&" + $("#storageInfoForm").serialize();
            }
            ,lang				: {
                firstPageText			: '首页',
                firstPageTipText		: '首页',
