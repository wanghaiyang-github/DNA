                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form id="queryForm" class="form-horizontal tasi-form" action="<%=path%>/center/3/uploadCountryDB.html" method="post">
                            ...
                            <table class="table table-striped table-advance table-bordered table-hover">
                                ...
                                <c:forEach items="${caseInfoList}" var="caseInfo" varStatus="ci">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="hidden" name="caseId" value="caseId" value="${caseInfo.entity.id}"/>
                                            <input type="hidden" name="consignmentId" value="${caseInfo.consignmentId}"/>
                                            <button class="btn btn-success btn-sm" name="compareBtn"><i class="fa fa-cloud-upload"></i> 上报</button>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
...
<script>
    $(function(){
        ...
        $("button[name='compareBtn']","#uploadNationalTbody").on("click",function(){
        ...
        kkpager.generPageHtml({
            ...
            //链接前部
            hrefFormer : '<%=path%>/center/3/uploadCountryDB',
            //链接尾部
            hrefLatter : '.html',
