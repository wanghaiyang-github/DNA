                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            <span class="label label-primary">手动导入codis</span>
...
console.log(geneInfo);
            ...
            /*$.ajax({
                url:"<%=path%>/center/3/saveGeneInfo.html?geneId=" + geneId,
                type:"post",
                ...
                success:function(data){
                    if(data.success){
                        ...
                        location.href = "<%=path%>/center/3/checkList.html?consignmentId=" + consignmentId + "&page=1";
                    }else {
                        alert("保存失败!");
                    }
                },
        ...
        function panelSelectChange(){
            ...
            $.ajax({
                url:"<%=path%>/center/3/selectPanelQuery.html",
                type:"post",
