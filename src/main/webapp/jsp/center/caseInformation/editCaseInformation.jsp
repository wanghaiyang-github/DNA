                ...
                <div class="panel-body">
                    <form id="caseinfo_form" class="form-horizontal tasi-form" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="caseLocationDesc" name="caseLocationDesc" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control required" placeholder="XXX公安司法鉴定中心"
                                       ...
                                       value="<c:if test="${empty limsConsignment.delegateOrgDesc}"><shiro:user><shiro:principal property="orgName"/></shiro:user></c:if>${limsConsignment.delegateOrgDesc}" readonly/>
                            </div>
                            <div class="col-sm-2 has-error hide">
                                <p class="help-block">必填项</p>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control required" id="identifyRequirement"
                                       name="identifyRequirement" value="${limsConsignment.identifyRequirement}"/>
                            </div>
                            <div class="col-sm-2 has-error hide">
                                <p class="help-block">必填项</p>
                            </div>
                        ...
                        <c:forEach items="${personSampleList}" var="personSample" varStatus="s">
                            <tr class="regedTr">
                                ...
                                <td><input type="hidden" name="personType"
                                           value="${personSample.personType}"> ${personSample.personTypeCode}</td>
                                ...
                                <td><input type="hidden" name="sampleType"
                                           value="${personSample.sampleType}"> ${personSample.sampleTypeCode}</td>
                                <td><input type="hidden" name="oneselfContact"
                                           value="${personSample.oneselfContact}"> ${personSample.oneselfContactCode}</td>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" name="entrustmentId" value="${personSample.entrustmentId}">
                                    <input type="hidden" name="personTypeCode" value="${personSample.personType}">
                                    <input type="hidden" name="sampelTypeCode" value="${personSample.sampleType}">
                                    <input type="hidden" name="caseInformationId" value="${personSample.caseInformationId}">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <div class="col-lg-offset-4 col-lg-10">
                            ...
                            <button class="btn btn-lg btn-primary" id="nextBtn" type="button"><i class="fa fa-save"></i>完成
                            </button>
