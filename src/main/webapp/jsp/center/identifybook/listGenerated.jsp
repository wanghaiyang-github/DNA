    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal tasi-form" action="<%=path%>/center/4/02.html" method="post" id="queryForm">
                    ...
                    <c:forEach items="${caseInfoList}" var="caseInfo" varStatus="ci">
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-info btn-sm" name="generateBtn"><i class="fa fa-file-o"></i> 重新生成鉴定书</button>
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6" style="text-align:center;">
                                        <button class="btn btn-primary btn-sm" id="downloadUploadBtn" name="downloadUploadBtn"><i class="fa fa-cloud-download"></i> 下载上传鉴定书</button>
                                    </div>
                                    <div class="col-sm-6" style="text-align:center;">
                                        <button class="btn btn-primary btn-sm" id="downloadRebuildBtn" name="downloadRebuildBtn"><i class="fa fa-cloud-download"></i> 下载生成鉴定书</button>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
...
<script>
    $(function(){
        ...
        $("button[name='uploadIdentifyBookBtn']","#reportedTbody").on("click",function(){
        ...
        $("button[name='generateBtn']","#reportedTbody").on("click",function(){
        ...
        $("button[name='downloadBtn']","#reportedTbody").on("click",function(){
        ...
        $("button[name='signBtn']","#reportedTbody").on("click",function(){
            if (!confirm("确定签发吗?"))
                return;
