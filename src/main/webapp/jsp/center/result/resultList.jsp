                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                                            ...
                                            <tr class="regedTr">
                                                ...
                                                <td>
                                                    ...
                                                    <c:if test="${acceptedSample.enterCount eq 0}">
                                                        未录入
                                                        <input type="hidden" name="enterCount" value="${acceptedSample.enterCount }">
                                                    </c:if>
                                        ...
                                        <c:if test="${sample.sampleFlag eq 0}">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <c:if test="${sample.enterCount eq 0}">
                                                        未录入
                                                        <input type="hidden" name="enterCount" value="${sample.enterCount}">
                                                    </c:if>
                                                    <c:if test="${sample.enterCount gt 0}">
                                                        已录入 ${sample.enterCount} 次
                                                    </c:if>
                            ...
                            <div class="form-group pull-right">
                                ...
                                <input type="hidden" name="caseNo" value="${caseInfo.caseNo}"/>
    ...
    $(function () {
        ...
        $("#nextStep").on("click",function(){
            ...
            $("tr", "#samplePersonTable").each(function () {
                ...
                var checkCount = $("input[name='enterCount']", $(this)).val();
            ...
            location.href = "<%=path%>/center/3/listGene.html?caseId=" + caseId;
