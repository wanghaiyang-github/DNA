        ...
        <section class="wrapper wrapper-delegate">
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            <span class="label label-primary">身份不明人员案件信息</span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            <span class="label label-primary">身份不明人员委托信息</span>
                           <span class="tools pull-right">
                           <a href="javascript:;" class="fa fa-chevron-down"></a>
                           </span>
                        </header>
...
<script>
    ...
    $(function () {
        ...
        function submitForm() {
            ...
            $.ajax({
                url : "<%=path%>/wt/reg/addCase.html?operateType="+operateType,
                type:"post",
                contentType:  "application/json; charset=utf-8",
                ...
                success : function(data) {
                    if (data.result){
                        ...
                        var delegateOrgDesc = data.delegateOrgDesc;
                        location.href = "<%=path%>/wt/reg/identifyPersonSampleReg.html?consignmentId=" + consignmentId + "&delegateOrgDesc=" + data.operateType +"&delegateOrgDesc="+delegateOrgDesc +"&caseId="+caseId;
                    }else {
                        alert("保存失败！");
                    }
                },
