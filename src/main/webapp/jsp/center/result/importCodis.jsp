...
<section id="main-content">
    <section class="wrapper">
        <div id="wrapper-content">
                            ...
                            <form class="form-horizontal tasi-form" method="get">
                                <div class="form-group">
                                    ...
                                    <label class="col-sm-2 control-label"
                                           style="text-align: right;"><strong>CODIS文件</strong></label>
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-2">
                                        <button class="btn btn-info" type="button" id="browserCodisBtn"><i
                                                class="fa  fa-folder-open"></i> 浏览...
                                        </button>
                                        <button class="btn btn-primary" type="button" id="importCodisBtn"><i
            ...
            <div class="modal fade" id="GeneDetailModal" aria-hidden="true" data-backdrop="static"
                 data-keyboard="false">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button data-dismiss="modal" class="btn btn-default" type="button" id="FinishedBtn"><i
...
<script>
    ...
    $(function () {
        ...
        function importCodisFtn() {
            ...
            $.ajaxFileUpload({
                cache: false,
                url: "<%=path%>/center/3/uploadCodis.html?reagentName=" + reagentName,
                secureuri: false,
