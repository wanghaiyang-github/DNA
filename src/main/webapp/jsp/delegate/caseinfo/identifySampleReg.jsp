                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button class="btn btn-success" type="button" id="SavePersonBtn">保 存</button>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button class="btn btn-success" type="button" id="SaveSampleBtn">保 存</button>
                                            <button data-dismiss="modal" class="btn btn-default" type="button">关闭</button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <div class="col-lg-offset-6 col-lg-10">
                                    ...
                                    <input type="hidden" id="caseId" value="${dataMap.caseId}"/>
                                    <input type="hidden" id="consignmentId" value="${dataMap.consignmentId}"/>
                                    <input type="hidden" id="consignmentStatus" value="${dataMap.status}"/>
                                    <c:choose>
...
<script src="<%=path%>/js/identifySampleReg.js"></script>
<script>
    generatePersonIdx();
