                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form id="queryForm" action="<%=path%>/center/caseinfo/finishedList.html" class="form-horizontal tasi-form" method="post">
                                ...
                                <c:forEach items="${caseInfoList}" var="caseInfo" varStatus="s">
                                    <tr>
                                        ...
                                        <%--<td>
                                            ...
                                            <button name="editBtn" class="btn btn-info"><i class="fa fa-pencil"></i> 修改</button>
                                            <button name="delBtn" class="btn btn-danger"><i class="fa fa-trash-o"></i> 删除</button>
                                        </td>--%>
                                    </tr>
                                </c:forEach>
                                </tbody>
...
<script>
    $(function(){
        ...
        kkpager.generPageHtml({
            ...
            //链接前部
            hrefFormer : '<%=path%>/center/caseinfo/finishedList',
            //链接尾部
            hrefLatter : '.html',
