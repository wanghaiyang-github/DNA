...
<script>
    $(function () {
        ...
        $("button[name='acceptBtn']").on('click', function () {
            ...
            location.href = '<%=path%>/center/caseInformation/addMissingExtraction.html?caseInformationId=' + caseInformationId;
        });

        $("button[name='viewBtn']", "#extractListTable").on("click",function(){
            var caseInformationId = $("input[name='caseInformationId']", $(this).parent()).val();
            location.href='<%=path%>/center/caseInformation/editMissingExtractRecord.html?caseInformationId='+caseInformationId;
        });
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data.success || data.success == true || data.success == "true") {
                        ...
                        location.href='<%=path%>/center/caseInformation/missingExtractionList.html?caseId=' + caseId;
                    }
                }
            });
        }
