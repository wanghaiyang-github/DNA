    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal tasi-form" action="<%=path%>/center/4/04.html" method="post" id="queryForm">
...
<script>
    $(function(){
        ...
        $("button[name='compareBtn']","#fetchTBody").on("click", function(){
