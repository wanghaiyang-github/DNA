...
$(function () {
    ...
    function submitPersonList(obj) {
        ...
        $.ajax({
            url: "../caseinfo/submitAcceptPerson.html",
            type: "post",
            ...
            success: function (data) {
                ...
                location.href = "../caseinfo/acceptCase.html?consignmentId=" + consignmentId;
            },
            error: function (e) {
                /* alert(123);*/
            }
    ...
    function submitSampleList(obj) {
        ...
        $.ajax({
            url: "../caseinfo/submitAcceptSample.html",
            type: "post",
            contentType: "application/json; charset=utf-8",
            data: JSON.stringify(params),
            dataType: "json",
    ...
    function GetSample() {
        ...
        if ($("input[name='acceptSampleFlag']:checked", "#sampleEvidenceTable").length > 0) {
            ...
            for (var i = 0; i < sampleEvidenceCnt; i++) {
                ...
                sample.evidenceNo = $("input[name='evidenceNo']", $sampleEvidenceTR).val();
...
// sample start
    ...
    function SaveSampleRow() {
        ...
        sample.id = sampleId;
        sample.evidenceNo = $.trim(evidenceNo);
    ...
    $("#refuseBtn").on("click", function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.success || data.success == true || data.success == "true") {
                    $("#wrapper-content").load("../../center/caseinfo/pendingAcceptList.html", function () {
                        $("#wrapper-content").fadeIn(100);
                    });
                }
            },
